...
{	
		...
		escolha(console)
			...
			enquanto (quan > estoque[0])
				...
				faca{
					...
					escreva("\n\n\t\t\t\t\tVocê escolheu ", quan , " unidades do Playstation 5. No total de R$ ",mat.arredondar(equacao,2))
			...
			enquanto (quan > estoque[1])
				...
				faca{
					...
					//escreva("\t\t\t\t\t\tTemos ", estoque[0], " Playstation 5 em nosso estoque.\n")
					escreva("\n\n\t\t\t\t\t\tVocê escolheu ", quant , " unidades do Playstation 4. No total de R$ ", mat.arredondar(equacao,2))
					escreva("\n\n\t\t\t\t\t\tGostaria de por no carrinho?\n\n\t\t\t\t\t\t[1] para Sim\t\t\t[2]Não")
					resposta()
					leia(comprar)}
				enquanto(comprar!=1 e comprar != 2)
			...
			enquanto (quan > estoque[2])
				...
				faca{
					...
					//escreva("\t\t\t\t\t\tTemos ", estoque[0], " Playstation 5 em nosso estoque.\n")
					escreva("\n\n\t\t\t\t\t\tVocê escolheu ", quan , " unidades do Nintendo Switch. No total de R$ ", mat.arredondar(equacao,2))
					escreva("\n\n\t\t\t\t\t\tGostaria de por no carrinho?\n\n\t\t\t\t\t\t[1] para Sim\t\t\t[2]Não")
					resposta()
					leia(comprar)}
				enquanto(comprar!=1 e comprar != 2)
			...
			enquanto (quan > estoque[3])
				...
				faca{
					...
					inteiro quant = tp.real_para_inteiro(quan) //Converte do real para inteiro
					//escreva("\t\t\t\t\t\tTemos ", estoque[0], " Playstation 5 em nosso estoque.\n")
					escreva("\n\n\t\t\t\t\t\tVocê escolheu ", quant , " unidades do Nintendo3ds. No total de R$ ", mat.arredondar(equacao,2))
					escreva("\n\n\t\t\t\t\t\tGostaria de por no carrinho?\n\n\t\t\t\t\t\t[1] para Sim\t\t\t[2]Não")
					resposta()
					leia(comprar)}
				enquanto(comprar!=1 e comprar != 2)
			...
			enquanto (quan > estoque[4])
				...
				faca{
					...
					inteiro quant = tp.real_para_inteiro(quan) //Converte do real para inteiro
					//escreva("\t\t\t\t\t\tTemos ", estoque[0], " Playstation 5 em nosso estoque.\n")
					escreva("\n\n\t\t\t\t\t\tVocê escolheu ", quant , " unidades do Xbox Series S. No total de  R$ ", mat.arredondar(equacao,2))
					escreva("\n\n\t\t\t\t\t\tGostaria de por no carrinho?\n\n\t\t\t\t\t\t[1] para Sim\t\t\t[2]Não")
					resposta()
					leia(comprar)}
				enquanto(comprar!=1 e comprar != 2)
		...
		"\n\t\t\t\ttempos de inicialização e melhorar a experiência geral do usuário\n\n")
			...
			enquanto (quan > estoque[5])
				...
				faca{
					...
					inteiro quant = tp.real_para_inteiro(quan) //Converte do real para inteiro
					escreva("\n\n\t\t\t\tVocê escolheu ", quant , " unidades da Placa Mãe. No total de R$ ", mat.arredondar(equacao,2))
					escreva("\n\n\t\t\t\tGostaria de por no carrinho?\n\n\t\t\t\t\t\t[1] para Sim\t\t\t[2]Não")
					resposta()
					leia(comprar)}
				enquanto(comprar!=1 e comprar != 2)
		...
		"\n\t\t\t\tpara desktop é imparável.Com os processadores AMD Ryzen para desktop, você está sempre na frente.\n\n")
			...
			enquanto (quan > estoque[6])
				...
				faca{
					...
					inteiro quant = tp.real_para_inteiro(quan) //Converte do real para inteiro
					escreva("\n\n\t\t\t\t\tVocê escolheu ", quant , " unidades da Processador AMD. No total de R$ ", mat.arredondar(equacao,2))
					escreva("\n\n\t\t\t\t\t\tGostaria de por no carrinho?\n\n\t\t\t\t\t\t[1] para Sim\t\t\t[2]Não")
					resposta()
					leia(comprar)}
				enquanto(comprar!=1 e comprar != 2)
		...
		"\n\t\t\t\taumenta o desempenho do seu computador e é adequado para pc e notebook\n\n")
			...
			enquanto (quan > estoque[7])
				...
				faca{
					...
					equacao = (quan * ssd)
					inteiro quant = tp.real_para_inteiro(quan) //Converte do real para inteiro
					escreva("\n\n\t\t\t\t\t\tVocê escolheu ", quant , " unidades do SSD. No total de R$ ", mat.arredondar(equacao,2))
					escreva("\n\n\t\t\t\t\t\tGostaria de por no carrinho?\n\n\t\t\t\t\t\t[1] para Sim\t\t\t[2]Não")
					resposta()
					leia(comprar)}
				enquanto(comprar!=1 e comprar != 2)
		...
		"\n\t\t\t\tGAMING GeForce RTX 3050 Twin Edge dá origem a jogos amplificados.\n\n")
			...
			enquanto (quan > estoque[8])
				...
				faca{
					...
					inteiro quant = tp.real_para_inteiro(quan) //Converte do real para inteiro
					escreva("\n\n\t\t\t\t\t\tVocê escolheu ", quant , " unidades da RTX 3050. No total de R$ ", mat.arredondar(equacao,2))
					escreva("\n\n\t\t\t\t\t\tGostaria de por no carrinho?\n\n\t\t\t\t\t\t[1] para Sim\t\t\t[2]Não")
					resposta()
					leia(comprar)}
				enquanto(comprar!=1 e comprar != 2)
		...
		"\n\t\t\t\tA vida útil do ventilador do rolamento hidráulico é superior a 4 anos.\n\n")
			...
			enquanto (quan > estoque[9])
				...
				faca{
					...
					equacao = (quan * fonte)
					inteiro quant = tp.real_para_inteiro(quan) //Converte do real para inteiro
					escreva("\n\n\t\t\t\t\t\tVocê escolheu ", quant , " unidades da Fonte. No total de R$ ", mat.arredondar(equacao,2))
					escreva("\n\n\t\t\t\t\t\tGostaria de por no carrinho?\n\n\t\t\t\t\t\t[1] para Sim\t\t\t[2]Não")
					resposta()
					leia(comprar)}
				enquanto(comprar!=1 e comprar != 2)
          ...
          "\n\t\t\t\tÉ Pro e pronto.\n\n")
			...
			enquanto (quan > estoque[11])
				...
				faca{
					...
					inteiro quant = tp.real_para_inteiro(quan) //Converte do real para inteiro
					escreva("\n\n\t\t\t\t\t\tVocê escolheu ", quant , " unidades da Iphone 13 Pro. No total de R$ ", mat.arredondar(equacao,2))
					escreva("\n\n\t\t\t\t\t\tGostaria de por no carrinho?\n\n\t\t\t\t\t\t[1] para Sim\t\t\t[2]Não")
					resposta()
					leia(comprar)}
				enquanto(comprar!=1 e comprar != 2)
		...
		"\n\t\t\t\tcom uma Super Retina XDR com ProMotion OLED sem bordas de 6,7 polegadas. É Pro e pronto.\n\n")
			...
			enquanto (quan > estoque[12])
				...
				faca{
					...
					inteiro quant = tp.real_para_inteiro(quan) //Converte do real para inteiro
					escreva("\n\n\t\t\t\t\t\tVocê escolheu ", quant , " unidades da Iphone 13 Pro Max. No total de R$ ", mat.arredondar(equacao,2))
					escreva("\n\n\t\t\t\t\t\tGostaria de por no carrinho?\n\n\t\t\t\t\t\t[1] para Sim\t\t\t[2]Não")
					resposta()
					leia(comprar)}
				enquanto(comprar!=1 e comprar != 2)
	...
	funcao carrinho() //painel do carrinho
		...
		para(i;i<carrin;i++){
			...
			arredondado= mat.arredondar(valortotal, 2)
			escreva("\t\t\t\t O valor total da sua compra é: ",arredondado,"\n")	
 ...
 * 
 * @POSICAO-CURSOR = 51018; 
 * @DOBRAMENTO-CODIGO = [24, 519, 528, 532, 538, 544, 549, 556, 565, 592];
 * @PONTOS-DE-PARADA = ;
